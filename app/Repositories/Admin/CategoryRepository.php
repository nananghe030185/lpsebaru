...
class CategoryRepository extends BaseRepository
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            return to_route('category.index')->with('success', __('Category Create Successfully'));
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            return to_route('category.index')->with('success', __('Category Updated Successfully'));
