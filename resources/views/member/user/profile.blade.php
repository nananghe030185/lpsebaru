<form method="POST" action="{{ route('app.user.update-profile', $user) }}" enctype="multipart/form-data" class="theme-form">
    @csrf
    @method('PUT')
        ...
        <div class="row custom-input">
            ...
            <div class="col-xxl-6 box-col-12">
                <div class="mb-3">
                    ...
                    <input class="form-control" id="kata_kunci" name="kata_kunci" type="text" placeholder="pisahkan dengan koma" value="{{ old('kata_kunci', $user->kata_kunci ?? '') }}">
                    @error('kata_kunci')
                        <span class="text-danger">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-text">
                            <div class="form-check checkbox checkbox-solid-info">
                                ...
                                <label class="form-check-label" for="notif_whatsapp_tender" data-bs-toggle="tooltip" title="Notifikasi Whatsapp untuk Tender">
                                    <span>Tender</span>
                                </label>
                            </div>
