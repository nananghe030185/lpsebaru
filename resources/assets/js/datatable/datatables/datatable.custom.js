(function ($) {
    $(document).ready(function () {
        ...
        $("#top-customer").DataTable({
            ...
            fixedColumns: {
                leftColumns: 3, // Note: 'start' is changed to 'leftColumns' in jQuery DataTables
            },
            searchable: true,
            pageLength: 5,
            autoWidth: false,
        ...
        $("#team-performance-table").DataTable({
            fixedColumns: {
                leftColumns: 2,
            },
            order: [[1, "asc"]],
        ...
        // Dashboard-13
        $("#shipment-tracking-table").DataTable({
            columnDefs: [
                {
                    orderable: false,
                    render: $.fn.dataTable.render.select(),
            ...
            layout: {
                topStart: {
                    buttons: [
                        {
                            extend: "copy",
                            className: "btn btn-outline-primary", // Ensure only btn-secondary is applied
                        },
                        {
                            extend: "csv",
